...
abstract class SliceDatabase : RoomDatabase() {
    ...
    /**
     * Define a companion object, this allows us to add functions on the SliceDatabase class.
     */
    companion object {
        /**
         ...
         */
        fun getInstance(context: Context): SliceDatabase {
